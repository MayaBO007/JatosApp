...
let questions = [
    {
        ...
        choiceA: 'משך המשחק אינו מוגדר מראש, אך המשחק יכול להימשך עד ארבעה ימים',
        choiceB: 'שבועיים',
        choiceC: 'חודש',
        correct: "A"
    }, {
    ...
    , {
        ...
        question: 'האם אפשר לסגור את החלון של המשחק?',
        choiceA: 'כן, אין בעיה',
        choiceB: 'לא, אם סוגרים נגמר המשחק',
        choiceC: 'לא, אבל אם נסגר לי אצור קשר במייל לעדכן בהקדם ',
        correct: "C"
    }
];
